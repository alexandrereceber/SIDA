...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../../CSS/Componentes/TabelaHTML.css?sd">
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <link rel="stylesheet" href="../../../uploadsFiles/css/prettyPhoto.css?" type="text/css" media="screen" charset="utf-8" />
        ...
        <script src="../../../Componentes/viewImagens.js?ddsd" defer=""></script>
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>

        <script  src="../../../Componentes/ShowWindows.js?q=1" defer="defer"></script>
